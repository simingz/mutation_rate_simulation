...
dat0 <- dat[dat$chr=="chr20" &  dat$start > 62037542 - 6e6 & dat$start < 62037542 + 6e6, ]
# Run smash.
mu.est = smash(dat0$obs, "poiss")
plot(dat0$start/1e6, dat0$obs, type = "l", col=NA, lwd=1.5, ylab= "# mutations/window", xlab = "Genomic position (Mb)", ylim=c(0,max(dat0$obs)))
